         ...
         <div class="w3-container" style="color:black">
            ...
            <?php  
                ...
                ?>
                    ...
                    <p>Ting Ting!! Có đơn hàng mới này. Mau mau đóng hàng rồi bấm xác nhận nhé</p>
                    <form method="POST">
                        <input type="hidden" name="deliveryStatus" value="CHO_GIAO_HANG">
                        <input type="submit" value="Đóng hàng xong" class="w3-hover-red w3-<?=$color_status?>">
                    </form>
                <?php        
                }
            ?>
