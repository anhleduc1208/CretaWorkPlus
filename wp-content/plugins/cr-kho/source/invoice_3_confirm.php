         ...
         <div class="w3-container" style="color:black">
            ...
            <?php  
                ...
                ?>
                    ...
                    <p>Hàng đã được chuyển. Kinh doanh xác nhận lại với khách rồi nhấn nút dưới này để hoàn tất hóa đơn nhé</p>
                    <form method="POST">
                        <input type="hidden" name="deliveryStatus" value="HOAN_THANH">
                        <input type="submit" value="Khách đã nhận" class="w3-hover-red w3-<?=$color_status?>">
                    </form>
                <?php        
                }
            ?>
